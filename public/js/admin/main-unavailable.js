/**
 * Unavailable Page Initialization
 */
...
function updateNavItems() {
    ...
    document.querySelector('[data-view="unavailable"]')?.classList.add('active');
}

function initializeUnavailable() {
    if (typeof UnavailableManager === 'undefined' || typeof ProfileManager === 'undefined') return;
